...
var adminUser_model_1 = require("../models/adminUser.model");
...
router.get("/admin/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productCount;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, adminUser_model_1.AdminModel.countDocuments()];
            case 1:
                productCount = _a.sent();
                if (productCount > 0) {
                    res.send("Seed is already done!");
                ...
                return [4 /*yield*/, adminUser_model_1.AdminModel.create(data_1.sample_admin)];
            case 2:
                _a.sent();
                res.send("Seed is done!");
                return [2 /*return*/];
...
router.post("/admin/login", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, email = _a.email, password = _a.password;
                return [4 /*yield*/, adminUser_model_1.AdminModel.findOne({ email: email, password: password })];
            case 1:
                user = _b.sent();
                if (user) {
                    res.send(generateTokenResponse(user));
