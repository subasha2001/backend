...
router.post("/create", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var requestOrder, cartItems, product, newOrder, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.trys.push([2, 6, , 7]);
                return [4 /*yield*/, products_model_1.ProductsModel.findById({
            ...
            case 3:
                ...
                if (product.stock < requestOrder.quantity) {
                    return [2 /*return*/, res.status(400).send("Not enough stock available")];
                }
